...
VALUES(123, "a@gmail.com", "Tran Mau That", "0123456789", "Author", "MBBANK - 1234567", 2003, '2023-10-30');
...
INSERT INTO employee(EmployeeID, EEmailAddress, EName, EPhoneNum, EType, EBankAccount, BranchID, EStartDate) 
VALUES(456, "b@gmail.com", "Tran Le Quoc Khanh", "0969696969", "Editor", "SGB - 2222223", 2003, '2023-10-30');
INSERT INTO `user` (Username, UCreatedDate, ULastLogin, UName, UBirthDate, Utype, UHasedPassword)
VALUES
...
INSERT INTO employee(EmployeeID, EEmailAddress, EName, EPhoneNum, EType, EBankAccount, BranchID, EStartDate) 
VALUES(789, "c@gmail.com", "Phan Tran Minh Dat", "0001110001", "Manager", "AGB - 25251325", 2003, '2023-10-30');
INSERT INTO Manager(ManagerID, BranchID) 
VALUE(789, 2003);

INSERT INTO employee(EmployeeID, EEmailAddress, EName, EPhoneNum, EType, EBankAccount, BranchID, EStartDate) 
VALUES(111, "d@gmail.com", "Phan Le Nhat Minh", "6969690000", "Accountant", "VIB - 100307979", 2003, '2023-10-30');
